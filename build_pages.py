    ...
    <div class="price-cards">
      ...
      <div class="price-card reveal">
        ...
        <ul class="check-list">
          ...
          <li>Holy Hydration Detox, Belly Burner Pineapple Cleanse, Apple Cider Glow Drink, and Green Fat Flush Juice</li>
          <li>Payhip devotional purchase link opens after checkout</li>
...
<section class="section section--cream2">
  <div class="container">
    <div class="section-head reveal">
      ...
      <p>The 3-Day Detox Challenge includes 9 regular juices from Healing Greens, Carrot Glow, Beet &amp; Bless, Golden Glow, King&rsquo;s/Queen&rsquo;s Power, and Island Glow. The 7-Day Detox includes 21 regular juices plus wellness shots.</p>
    </div>
...
<section class="section" id="devotional">
  <div class="container">
    <div class="split">
      ...
      <div class="reveal">
        <span class="eyebrow">Pairs with the 7-day transformation</span>
        <h2>The 7-Day Faith &amp; Fit Reset</h2>
        <p class="muted">After you purchase the 7-Day Soul Slim Line Transformation, we&rsquo;ll send you to Payhip to purchase the devotional and printable tracker separately.</p>
        <a class="btn btn--gold" href="https://payhip.com/b/FTiIB">
          Buy the Devotional on Payhip
